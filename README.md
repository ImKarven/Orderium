...
<br>Folia is supported but it is extremely experimental, avoid if possible.
...
<br>If you found any exploits or dupe glitches, formerly report the vulnerability by sending an email to orderium@atomicmail.io.
