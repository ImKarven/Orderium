...
public enum StorageMethod {
    ...
    public static void init(Orderium orderium) {
        ...
        SQLITE.createOrderTableStatement = "CREATE TABLE IF NOT EXISTS " + ORDER_TABLE() + " (id INTEGER PRIMARY KEY AUTOINCREMENT, owner_most BIGINT, owner_least BIGINT, item BLOB, money_per DOUBLE, amount INT, delivered INT DEFAULT 0, in_storage INT DEFAULT 0, expires_at BIGINT)";
